...
for i, r in enumerate(rows):
    ...
    rows_html += f'''<div style="display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;padding:16px 24px;border-top:1px solid rgba(255,255,255,0.05);background:rgba(255,255,255,{bg});">
        <div style="font-size:22px;font-weight:600;color:{BRANCO};line-height:1.3;">{r[0]}</div>
        <div style="font-size:26px;text-align:center;">{r[1]}</div>
        <div style="font-size:26px;text-align:center;">{r[2]}</div>
        <div style="font-size:26px;text-align:center;">{r[3]}</div>
    </div>'''
...
<p class="sub">15 de abril de 2026 · Slides 2 a 8 · 1080x1350px · Informações verificadas</p>
<div class="controls">
...
<div class="slide" id="s2" style="background:{CINZA};">
  ...
  <div style="padding:72px 88px 0;">
    ...
    <div style="font-size:80px;font-weight:900;color:{PRETO};line-height:1.0;margin-bottom:40px;">Nem todo calçado protege<br><span style="color:{AZUL};">do mesmo jeito.</span></div>
...
<div class="slide" id="s3" style="background:{PRETO};">
  ...
  <div style="padding:60px 88px;">
    <div style="display:flex;align-items:center;gap:20px;margin-bottom:28px;">
      <div style="background:{LARANJA};border-radius:12px;padding:10px 22px;"><span style="font-size:14px;font-weight:800;letter-spacing:2px;color:{BRANCO};text-transform:uppercase;">Tipo 01 de 03</span></div>
    </div>
    <div style="font-size:26px;font-weight:700;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:2px;margin-bottom:8px;">Biqueira de</div>
    <div style="font-size:100px;font-weight:900;color:{BRANCO};line-height:1.0;margin-bottom:44px;">AÇO</div>
    <div style="display:flex;flex-direction:column;gap:18px;">
      <div style="background:rgba(255,255,255,0.06);border-radius:14px;padding:24px 30px;border-left:5px solid {LARANJA};display:flex;gap:18px;align-items:flex-start;">
        <span style="font-size:28px;flex-shrink:0;">🏗️</span>
        <div><div style="font-size:19px;font-weight:800;color:{LARANJA};letter-spacing:1px;margin-bottom:5px;">ALTA RESISTÊNCIA</div>
        <div style="font-size:25px;color:{BRANCO};font-weight:600;line-height:1.3;">Suporta 200 J de impacto e 15 kN de compressão (ABNT NBR ISO 20345)</div></div>
      </div>
      <div style="background:rgba(255,255,255,0.06);border-radius:14px;padding:24px 30px;border-left:5px solid {AZUL};display:flex;gap:18px;align-items:flex-start;">
        <span style="font-size:28px;flex-shrink:0;">🎯</span>
        <div><div style="font-size:19px;font-weight:800;color:{AZUL};letter-spacing:1px;margin-bottom:5px;">INDICADO PARA</div>
        <div style="font-size:25px;color:{BRANCO};font-weight:600;line-height:1.3;">Construção civil, siderurgia, metalurgia e indústria pesada</div></div>
      </div>
      <div style="background:rgba(231,76,60,0.15);border-radius:14px;padding:24px 30px;border-left:5px solid {VERMELHO};display:flex;gap:18px;align-items:flex-start;">
        <span style="font-size:28px;flex-shrink:0;">⚡</span>
        <div><div style="font-size:19px;font-weight:800;color:{VERMELHO};letter-spacing:1px;margin-bottom:5px;">ATENÇÃO</div>
        <div style="font-size:25px;color:{BRANCO};font-weight:600;line-height:1.3;">Conduz eletricidade e temperatura — não usar em risco elétrico ou calor extremo</div></div>
      </div>
      <div style="background:rgba(255,255,255,0.06);border-radius:14px;padding:24px 30px;border-left:5px solid rgba(255,255,255,0.2);display:flex;gap:18px;align-items:flex-start;">
        <span style="font-size:28px;flex-shrink:0;">⚖️</span>
        <div><div style="font-size:19px;font-weight:800;color:rgba(255,255,255,0.5);letter-spacing:1px;margin-bottom:5px;">PONTO DE ATENÇÃO</div>
        <div style="font-size:25px;color:{BRANCO};font-weight:600;line-height:1.3;">A mais pesada — pode causar mais fadiga em jornadas longas</div></div>
      </div>
    </div>
  </div>
  {rodape()}
...
<div class="slide" id="s4" style="background:{AZUL};">
  ...
  <div style="padding:60px 88px;">
    <div style="display:flex;align-items:center;gap:20px;margin-bottom:28px;">
      <div style="background:rgba(255,255,255,0.2);border-radius:12px;padding:10px 22px;"><span style="font-size:14px;font-weight:800;letter-spacing:2px;color:{BRANCO};text-transform:uppercase;">Tipo 02 de 03</span></div>
    </div>
    <div style="font-size:26px;font-weight:700;color:rgba(255,255,255,0.55);text-transform:uppercase;letter-spacing:2px;margin-bottom:8px;">Biqueira</div>
    <div style="font-size:90px;font-weight:900;color:{BRANCO};line-height:1.0;margin-bottom:10px;">COMPOSITE</div>
    <div style="font-size:22px;font-weight:700;color:{AMARELO};margin-bottom:40px;">Fibra de carbono + fibra de vidro + resina de poliéster</div>
    <div style="display:flex;flex-direction:column;gap:16px;">
      <div style="background:rgba(255,255,255,0.12);border-radius:14px;padding:22px 30px;display:flex;gap:18px;align-items:center;">
        <span style="font-size:28px;">🔌</span>
        <div style="font-size:25px;color:{BRANCO};font-weight:700;line-height:1.3;"><span style="color:{AMARELO};">Isolante elétrico</span> — ideal para eletricistas e risco de choque</div>
      </div>
      <div style="background:rgba(255,255,255,0.12);border-radius:14px;padding:22px 30px;display:flex;gap:18px;align-items:center;">
        <span style="font-size:28px;">🪶</span>
        <div style="font-size:25px;color:{BRANCO};font-weight:700;line-height:1.3;"><span style="color:{AMARELO};">~35% mais leve</span> que a biqueira de aço</div>
      </div>
      <div style="background:rgba(255,255,255,0.12);border-radius:14px;padding:22px 30px;display:flex;gap:18px;align-items:center;">
        <span style="font-size:28px;">🛡️</span>
        <div style="font-size:25px;color:{BRANCO};font-weight:700;line-height:1.3;">Mesma certificação: <span style="color:{AMARELO};">200 J impacto + 15 kN compressão</span></div>
      </div>
      <div style="background:rgba(255,255,255,0.12);border-radius:14px;padding:22px 30px;display:flex;gap:18px;align-items:center;">
        <span style="font-size:28px;">🧲</span>
        <div style="font-size:25px;color:{BRANCO};font-weight:700;line-height:1.3;">Não detectada por <span style="color:{AMARELO};">detector de metais</span></div>
      </div>
      <div style="background:rgba(0,0,0,0.2);border-radius:14px;padding:22px 30px;display:flex;gap:18px;align-items:center;">
        <span style="font-size:28px;">💰</span>
        <div style="font-size:25px;color:rgba(255,255,255,0.8);font-weight:600;line-height:1.3;">Custo mais elevado — compensa para riscos específicos</div>
      </div>
    </div>
  </div>
  {rodape()}
...
<div class="slide" id="s5" style="background:{CINZA};">
  <div style="height:10px;background:{AZUL};"></div>
  <div style="padding:60px 88px 0;">
    <div style="display:flex;align-items:center;gap:20px;margin-bottom:28px;">
      <div style="background:{PRETO};border-radius:12px;padding:10px 22px;"><span style="font-size:14px;font-weight:800;letter-spacing:2px;color:{BRANCO};text-transform:uppercase;">Tipo 03 de 03</span></div>
    </div>
    <div style="font-size:26px;font-weight:700;color:#888;text-transform:uppercase;letter-spacing:2px;margin-bottom:8px;">Biqueira</div>
    <div style="font-size:90px;font-weight:900;color:{PRETO};line-height:1.0;margin-bottom:10px;">PLÁSTICA</div>
    <div style="font-size:22px;font-weight:700;color:{AZUL};margin-bottom:40px;">Polipropileno injetado — para riscos leves</div>
    <div style="display:flex;flex-direction:column;gap:18px;">
      <div style="background:{BRANCO};border-radius:14px;padding:24px 34px;box-shadow:0 4px 20px rgba(0,0,0,0.06);border-left:6px solid {VERDE};display:flex;gap:18px;align-items:flex-start;">
        <span style="font-size:28px;flex-shrink:0;">✅</span>
        <div><div style="font-size:19px;font-weight:800;color:{VERDE};letter-spacing:1px;margin-bottom:4px;">VANTAGENS</div>
        <div style="font-size:25px;color:{PRETO};font-weight:600;line-height:1.3;">Mais leve e confortável. Não conduz eletricidade.</div></div>
      </div>
      <div style="background:{BRANCO};border-radius:14px;padding:24px 34px;box-shadow:0 4px 20px rgba(0,0,0,0.06);border-left:6px solid {AZUL};display:flex;gap:18px;align-items:flex-start;">
        <span style="font-size:28px;flex-shrink:0;">🎯</span>
        <div><div style="font-size:19px;font-weight:800;color:{AZUL};letter-spacing:1px;margin-bottom:4px;">INDICADA PARA</div>
        <div style="font-size:25px;color:{PRETO};font-weight:600;line-height:1.3;">Ambientes com riscos leves: varejo, logística leve, laboratório</div></div>
      </div>
      <div style="background:rgba(231,76,60,0.08);border-radius:14px;padding:24px 34px;border-left:6px solid {VERMELHO};display:flex;gap:18px;align-items:flex-start;">
        <span style="font-size:28px;flex-shrink:0;">⚠️</span>
        <div><div style="font-size:19px;font-weight:800;color:{VERMELHO};letter-spacing:1px;margin-bottom:4px;">LIMITAÇÃO IMPORTANTE</div>
        <div style="font-size:25px;color:{PRETO};font-weight:600;line-height:1.3;">Resistência menor que aço e composite. Não usar em ambientes de alto risco de impacto.</div></div>
      </div>
      <div style="background:{BRANCO};border-radius:14px;padding:24px 34px;box-shadow:0 4px 20px rgba(0,0,0,0.06);border-left:6px solid rgba(0,0,0,0.1);display:flex;gap:18px;align-items:flex-start;">
        <span style="font-size:28px;flex-shrink:0;">💡</span>
        <div><div style="font-size:19px;font-weight:800;color:#555;letter-spacing:1px;margin-bottom:4px;">REGRA</div>
        <div style="font-size:25px;color:{PRETO};font-weight:600;line-height:1.3;">Sempre confira o CA para saber qual nível de proteção o calçado oferece</div></div>
      </div>
    </div>
  </div>
  {rodape()}
...
async function baixarTodos(){{
  const slides=[['s2','02-introducao'],['s3','03-biqueira-aco'],['s4','04-biqueira-composite'],
